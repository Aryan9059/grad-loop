      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-3xl">
        ...
        >
          ...
          <div className="relative flex items-center justify-between">
            <div className="p-3 rounded-xl bg-gradient-to-br from-violet-500/10 to-indigo-500/10 group-hover:from-violet-500/20 group-hover:to-indigo-500/20 transition-colors">
        ...
        >
          ...
          <div className="relative flex items-center justify-between">
            <div className="p-3 rounded-xl bg-gradient-to-br from-amber-500/10 to-orange-500/10 group-hover:from-amber-500/20 group-hover:to-orange-500/20 transition-colors">
